...
@section('space-work')
    <div class="flex items-center justify-center h-screen bg-red-100 ">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="flex flex-shrink-0 ml-4">
                                    <button type="button" onclick="closeAlertBox()"
                                        class="inline-flex text-gray-400 bg-white rounded-md hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
        ...
        <div class="w-[90%] lg:w-1/3">
            <form action="{{ route('userLogin') }}" method="POST"
                class="min-w-full p-10 bg-white rounded-lg shadow-lg ">
                @csrf
                <div class="flex justify-center"><img src="{{asset('images/eurekalearnings-logo.png')}}" alt="Company Logo" class="w-[200px]"></div>

                <div>
                    <label class="block my-3 font-semibold text-gray-800  text-md"
                        for="email">Email</label>
                    <input
                        class="w-full px-4 py-2 text-gray-700  :text-gray-600 bg-gray-100  :bg-gray-900 rounded-lg focus:outline-none @error('email') border border-red-500 @enderror"
                ...
                <button type="submit"
                    class="w-full px-4 py-2 mt-6 font-sans text-lg font-semibold tracking-wide text-white bg-red-600 rounded-lg">Login</button>
                <!--<div class="flex justify-between">-->
                <!--    <a href="/register" class="text-blue-500 hover:underline">Sign Up</a>-->
                <!--    <a href="/forgot-password" class="text-blue-500 hover:underline">Forgor Password?</a>-->
                <!--</div>-->
                <div class="py-2">
                    <p class="text-lg text-center text-red-500">{{ Session::get('error') }}</p>
                </div>
